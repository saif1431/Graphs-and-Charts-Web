                ...
                var particles = [];
                let speed1 = document.querySelector('.speedBtn1');
                let speed2 = document.querySelector('.speedBtn2');
                let speed3 = document.querySelector('.speedBtn3');
                ...
                window.addEventListener('load', function() {
                    ...
                    var resize = function() {
                        canvasWidth  = canvas.width = 1500;
                        canvasHeight = canvas.height = 1500;
